						...
						<div class="col-sm-8">
							<form method="post">
								<div  style="position: relative;" class="search_box pull-right">
									<input id="search" type="text" style ="color: #000;font-weight:1000" placeholder="Tìm Kiếm Sản Phẩm"/><button id="btn-search" style="position: absolute; top: 5px;font-weight:500px; font-size: 23px;right: 3px; color:#000;border: none;background: none;" class="fas fa-search btnn"></button >
								</div>
							</form>
						</div>
				</div>
